!(function (n) {
    ...
    function s(n, e) {
      for (var t = {}, o = [], r = 0; r < n.length; r++) {
        ...
        -1 !== l
          ...
          : a.push({ identifier: u, updater: b(f, e), references: 1 }),
          o.push(u);
      }
      return o;
    }
    ...
    n.exports = function (n, e) {
      ...
      return function (n) {
        if (
          ...
          for (var i = s(n, e), d = 0; d < t.length; d++) {
            var u = c(t[d]);
  ...
  function (n, e, t) {
    ...
    document.querySelector('#result').addEventListener('click', (n) => {
      const { className: e } = n.target;
      if ('delete' === e) {
        const { index: e } = n.target.parentElement.dataset;
        todos.splice(e, 1), r(todos);
      } else if ('toggle-checked' === e) {
        const { index: e } = n.target.parentElement.dataset;
        (todos[e].isDone = !todos[e].isDone), r(todos);
      }
    }),
      r(todos);
  },
